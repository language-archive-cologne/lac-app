...
class TestCollectionImporterIntegration:
    ...
    def test_extract_metadata_license(self, cmd_data):
        ...
        license_value, license_uri = CollectionImporter._extract_metadata_license(cmd_data)
        
        # Verify the result matches what's in the XML
        assert license_value == "CC0"
        assert license_uri == "https://creativecommons.org/public-domain/cc0/"
