...
# Delay between derivative existence checks within a single WAV audit.
DERIVATIVE_AUDIT_ARTIFACT_DELAY_SECONDS = env.float(
...
DERIVATIVE_AUDIT_CONNECTIVITY_BACKOFF_BASE_SECONDS = env.float(
    "DERIVATIVE_AUDIT_CONNECTIVITY_BACKOFF_BASE_SECONDS",
    default=1.0,
)
DERIVATIVE_AUDIT_CONNECTIVITY_BACKOFF_MAX_SECONDS = env.float(
    "DERIVATIVE_AUDIT_CONNECTIVITY_BACKOFF_MAX_SECONDS",
    default=30.0,
)
DERIVATIVE_AUDIT_MAX_CONSECUTIVE_CONNECTIVITY_FAILURES = env.int(
