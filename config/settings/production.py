...
SEARCH_GRANT_RATE_LIMIT = env.int("SEARCH_GRANT_RATE_LIMIT")
SEARCH_GRANT_RATE_WINDOW_SECONDS = env.int("SEARCH_GRANT_RATE_WINDOW_SECONDS")
...
_PRIVATE_SEARCH_LIMITS = {
    ...
    "SEARCH_GRANT_RATE_LIMIT": SEARCH_GRANT_RATE_LIMIT,
    "SEARCH_GRANT_RATE_WINDOW_SECONDS": SEARCH_GRANT_RATE_WINDOW_SECONDS,
...
# Explicitly set USE_MINIO to False for production
...
EMAIL_SUBJECT_PREFIX = env(
    ...
    default="[Language Archive Cologne] ",
)
